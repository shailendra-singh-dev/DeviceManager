...
/**
 * Created by iTexico Developer on 7/13/2016.
 */
public class CircularImageView extends ImageView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        int circleCenter = (int) (canvasSize - (mBorderWidth * 2)) / 2;
        // Draw Border
        canvas.drawCircle(circleCenter + mBorderWidth, circleCenter + mBorderWidth, circleCenter + mBorderWidth - (shadowRadius + shadowRadius / 2), paintBorder);
        // Draw CircularImageView
        canvas.drawCircle(circleCenter + mBorderWidth, circleCenter + mBorderWidth, circleCenter - (shadowRadius + shadowRadius / 2), paint);
    }
